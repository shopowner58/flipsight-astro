...
export const getStockBadgeTone = (stockStatus: StockStatus) => {
  ...
  if (stockStatus === "New") return "bg-[#c4572a] text-white";
...
export const hasStockBadge = (stockStatus: StockStatus) =>
  stockStatus === "Sold out" || stockStatus === "Low stock" || stockStatus === "Pre-order" || stockStatus === "New";
